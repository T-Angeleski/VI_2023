...
if __name__ == '__main__':
	...
	mappedDataset = []
	for row in dataset:
		newRow = [float(el) for el in row[:-1]] + [row[-1]]
		mappedDataset.append(newRow)
	
	dividePoint = int(0.85 * len(mappedDataset))
	trainSet = mappedDataset[:dividePoint]
	testSet = mappedDataset[dividePoint:]
	...
	predictedEntry = classifier.predict([entry])[0]
